      ...
      <div className="container mx-auto px-4 py-12">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                <Mail className="h-5 w-5 text-blood-red mr-3" />
                <span className="text-gray-300">support@blooddonation.com</span>
              </div>
              <div className="flex items-center">
                <Phone className="h-5 w-5 text-blood-red mr-3" />
                <span className="text-gray-300">+1 (555) 123-4567</span>
              </div>
              <div className="flex items-center">
                <MapPin className="h-5 w-5 text-blood-red mr-3" />
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} BloodDonation System. All rights reserved.
          </p>
          <p className="text-gray-400 text-sm mt-2 md:mt-0">
            Made with <Heart className="inline h-4 w-4 text-blood-red" /> to save lives
          </p>
        </div>
      </div>
    </footer>
